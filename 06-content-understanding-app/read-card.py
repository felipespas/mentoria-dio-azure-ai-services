...
def main():
    ...
    # List the files in the input directory and store in a list
    ...
    for file in input_files:
        ...
        try:            
            ...
            analyze_card (image_file, analyzer, ai_svc_endpoint, ai_svc_key, script_dir, filename)
...
def analyze_card (image_file, analyzer, endpoint, key, script_dir, filename):
    ...
    if status == "Succeeded":
        ...
        output_file = output_dir / f"{filename}-results.json"
